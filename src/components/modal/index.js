						...
						<div className="modal-container">
								<div className="modal-text">
										<div className="modal-price">
												...
												{/*<h3> Pague apenas:</h3>*/}
												{/*<h3>R$ 100,00/mês*</h3>*/}
												<div className="modal-info"><h3>Fale diretamente com a corretora Rita Leite!</h3></div>
										</div>
										{/*<h2>Inclui:</h2>*/}
										...
										<button
												...
												onClick={() => (window.location.href = "https://api.whatsapp.com/send/?phone=5511970753810&text=Olá!")}
										>
												Entre em contato!
										</button>
										<br/>
